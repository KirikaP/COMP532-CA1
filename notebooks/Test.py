...
plt.plot(x,eps_001_rate,linewidth=0.5,color='g',label="epsilon_greedy,epsilon=0.1")
plt.plot(x,eps_00_rate,linewidth=0.5,color='',label="epsilon_greedy,epsilon=0.1")
plt.xlabel('steps')
plt.ylabel('average reward')
plt.legend(loc="best")
plt.figure(2,figsize=(15,6))
plt.plot(x,y3,linewidth=0.5,label="epsilon_greedy")
plt.plot(x,y4,linewidth=0.5,color='r',label="ucb")
plt.xlabel('steps')
